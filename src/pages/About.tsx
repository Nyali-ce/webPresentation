    ...
    return (
        <motion.div 
            ...
            <div className='aboutSection'>
                ...
                I love working on the backend of applications, creating systems and APIs that handle the heavy lifting and data management of web and mobile applications. I enjoy using JavaScript and TypeScript to create scalable and efficient systems, as well as C, Python, and Java to tackle more complex problems.
